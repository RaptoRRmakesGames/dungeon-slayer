...
class Button:
    def __init__(self, pos, image, action, click_times=1, dissapear=True , text="", textcolor = (255,255,255), fontsize=30):
        ...
        if not self.text == "":
            self.font = pygame.font.SysFont("Minecraft", fontsize, False, False)
...
def write(screen,text, pos,size=60,color=(0,0,0),font=pygame.font.SysFont("Minecraft",60,True,False)):
    screen.blit(
